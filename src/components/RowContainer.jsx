...
const RowContainer = ({ flag, data }) => {
    console.log(data);
    return (
        <div className={`w-full flex items-center gap-3 my-12 bg-gradient-to-tl from-red-500 to red-800 ${flag ? 'overflow-x-scroll scrollbar-none' : 'overflow-x-hidden flex-wrap'}`}>
