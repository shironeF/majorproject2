...
import { getAllFoodItems, saveItem } from "../utils/firbaseFunctions";
                    ...
                    {isLoading ? (
                        ...
                        <>
                            {!imageAsset ? (
                                <>
                                    <label className='w-full h-full flex flex-col items-center justify-center cursor-pointer'>
                                        <div className='w-full h-full flex flex-col items-center justify-center'>
                                            <MdCloudUpload className='text-gray- text-3xl hover:text-gray-500 gap-2' />
                                            <p className='text-gray- text-3xl hover:text-gray-500'>Click here to upload</p>
                                        </div>
                                        <input
                                            type="file"
                                            name="uploadimage"
                                ...
                                <>
                                    <div className='relative h-full'> <img src={imageAsset} alt="upload image" className='w-full h-full object-cover' />
                                        <button type='button' className='absolute bottom-3 right-3 p-3 rounded-full bg-red-500 text-xl cursor-pointer outline-non hover:shadow-md duration-500 transition-all ease-in-out' onClick={deleteImage}>
