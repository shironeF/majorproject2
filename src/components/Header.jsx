...
import Logo from "../img/3075977.png";
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <div className='flex items-center gap-8'>
          <motion.ul
            ...
            <li className="text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer">Stores</li>
          ...
          <div className="relative">
            < motion.img whileTap={{ scale: 2 }}
              ...
              className="w-10 min-w-[60px] h-10 min-h-[55px] cursor-pointer rounded-full"
              alt="userprofile"
              onClick={login}
            />
            {
              isMenu && (<motion.div
                ...
                <p className="px-4 py-2 flex item-center gap-3 cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base" onClick={logout}>Logout <MdLogout /></p>
              </motion.div>
          ...
          />
          {
            isMenu && (<motion.div
              ...
              <ul className="flex flex-col">
                ...
                <li className="text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2">Stores</li>
